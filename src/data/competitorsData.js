export default [{
    ...
    description: [
      "Overcast first screen features an unusual navigation bar on the top of the screen with icons-only buttons. These are quite generic, like a plus symbol, or the logo of the app itself, for this reason it's quite difficult to understand what action they are performing.",
  ...
  },
  {
    ...
    description: [
      ...
      "The results are separated between users saved podcasts and the ones who are available in the feeds.",
      "Because of this mixed use, selecting one item can have two different outcomes, which is not helpful from a usability point of view."
    ]
  },
  {
    id: 3,
    ...
    description: [
      "The detail info of a podcast show contains the list of all episodes and a button to subscribe to it.",
      "When the show has already been listened, some more filters are displayed.",
      "It seems there is quite a small amount of info available for a show, which doesn't help the user in understanding if the podcast is valuable or not.",
    ]
  },
  {
    id: 4,
    ...
    description: [
      ...
      "As with the Home screen, this screen has also an unusual interaction design: there are two side panels in what seems more like a slideshow of pictures. Because of this strange interaction, the developer needed to place extra buttons at the bottom to make the functionality more explicit.",
  ...
  },
  {
    ...
    description: [
      "Downloaded episodes are displayed in a list, with no filters, grouping nor sorting.",
  ...
  },
  {
    ...
    description: [
      "Apple Podcasts search page clearly separate the results between users content and all the rest.",
  ...
  },
  {
    ...
    description: [
      "The detail page of a podcast has a clear primary call to action: the subscribe button. This is understandable because Apple searching algorithm is also based on the number of subscribers.",
      "The design separates secondary features in an hidden menu: unsubscribe, settings, remove from the library, play next and share.",
  ...
  },
  {
    ...
    description: [
      "The playing screen is entirely dedicated to the podcast cover. Worth to notice that the user interface is exactly the same as the Music app of other iOS devices.",
  ...
  },
  {
    ...
    description: [
      ...
      "The app offers only sort by title or date to organize this content, and quite surprisingly the affordance of the list is not intuitive: selecting a row starts the playback, while a 'details' link is shown to navigate to the correspondent page."
    ]
  }
];